...
public static class CodiceCatastale
{
    public static Dictionary<string, string> Comuni = new Dictionary<string, string>
    {
        { "A001", "ABANO TERME" },
        ...
        { "SSIO", "SICULO" },
        { "OGIO", "DI TORINO" },
        { "OGIO", "DI VALPOLICELLA" },
        { "OGIO", "SUL GARIGLIANO" },
        { "OLIA", "DI NARCO" },
        { "DREA", "APOSTOLO DELLO IONIO" },
        { "DREA", "DEL GARIGLIANO" },
        { "DREA", "DI CONZA" },
        { "DREA", "FRIUS" },
        { "GELO", "A CUPOLO" },
